...
<header>
    <div class="c900 overauto">
        ...
        <div class="hdbuttons">
            ...
            <a href="${resourceServer}/index.htm">返回首页</a>
                ...
                <li class="active">
                    ...
                    <div id="sortnav" class="mynav sort" style="width: 300px;">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="${dynamicServer}/pages/sort-01.html">基层党建实践路径研究及创新</a></li>
    ...
    <div class="sort">
        <div class="c900 content">
            <div class="status_wrap">
                ...
                <div class="status_su">操作成功</div>
                <button type="button" class="btn"
                        onclick="window.location.href='${dynamicServer}/contactUs/index.htm'">返回</button>
            </div>
        </div>
    </div>
</div>
