...
<header>
    ...
    <div class="mynav">
        <ul class="nav nav-tabs nav-justified">
            ...
            <li>
                <a href="<%=baseURL%>/pages/sort-01.html" id="sort">解决方案</a>
                <div id="sortnav" class="mynav sort" style="width: 300px;">
                    <ul class="nav nav-pills">
                        ...
                        <li><a href="<%=baseURL%>/pages/sort-07.html">新媒体信息推介服务</a></li>
                    </ul>
                </div>
            </li>
            <li>
            ...
            <li class="active">
                ...
                <div id="contactnav" class="mynav sort">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="<%=baseURL%>/contactUs/index.htm">联系我们</a></li>
                    </ul>
                </div>
            </li>
        </ul>
...
<div class="sortpg contactpg">
    <div class="banner">
        <img src="<%=baseURL%>/assets/img/5contact02-banner.png" alt="">
    </div>
    <div class="sort">
        ...
        <div class="c900 content">
            <table class="mytable" border="1" cellspacing="0" bordercolor="#ddd">
                <tr>
                    <td>
                        <img src="<%=baseURL%>/assets/img/5contact02-i1.png" alt="">
                        <p class="tt">公司地址</p>
                        <p>北京市朝阳区高碑店村二区49号</p>
                    </td>
                    <td>
                        <img src="<%=baseURL%>/assets/img/5contact02-i2.png" alt="">
                        <p class="tt">联系电话</p>
                        <p>010-56109331</p>
                    </td>
                    <td>
                        <img src="<%=baseURL%>/assets/img/5contact02-i3.png" alt="">
                        <p class="tt">电子邮箱</p>
                        <p>byztbj@163.com</p>
                    </td>
                </tr>
            ...
            <div class="row msg">
                <p class="us">给我们留言</p>
                <form role="form" id = "contactUsFrom" action="<%=baseURL%>/contactUs/add.htm" method="post" onsubmit="return sumbit();">
                    <div class="col-xs-6">
